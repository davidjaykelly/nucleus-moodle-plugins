...
$string['setting_issuer_desc'] = 'The hub\'s sign-in address: exactly the hub URL set in Nucleus > Hub connection, followed by /local/nucleushub/oidc (for example https://hub.example.com/local/nucleushub/oidc).';
