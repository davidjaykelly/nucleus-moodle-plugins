...
$string['statusbar_spoke_locked_title'] = 'Hub published with edit-lock — local content is read-only for editing teachers.';
$string['catalog_blocked_eyebrow'] = 'Pull blocked';
$string['catalog_blocked_notes'] = 'Other notes';
$string['catalog_blocked_remediation'] = 'What to do';
$string['catalog_blocked_retry'] = 'Retry pull';
$string['catalog_blocked_sub'] = 'This spoke can\'t pull this version yet. Install the missing plugins below, then click Retry.';
$string['catalog_mod_local_col'] = 'This spoke';
$string['catalog_mod_manifest_col'] = 'Manifest';
