...
$observers = [
    ...
    // Sign in with the hub: a deleted user's opaque subject goes with
    // them, so no later account can inherit their spoke accounts.
    [
        'eventname' => '\core\event\user_deleted',
        'callback'  => '\local_nucleushub\observer\oidc_subjects::user_deleted',
    ],
];
