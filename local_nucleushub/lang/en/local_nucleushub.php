...
$string['publish_lockedit_caption'] = 'Spokes that pull this version see the course as read-only — editing teachers can\'t modify activities, sections, or settings. Use for distribute-only content.';
$string['publish_lockedit_label'] = 'Lock spoke editing';
