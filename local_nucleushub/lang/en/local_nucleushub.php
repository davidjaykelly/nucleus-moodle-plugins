...
$string['invalidwwwroot'] = 'Nucleus couldn\'t move this spoke: the new address isn\'t a valid URL, or isn\'t https while this hub is.';
...
$string['spokenotfound'] = 'Nucleus couldn\'t move this spoke: this hub has no active spoke with the ID {$a}.';
...
$string['spokeurlinuse'] = 'Nucleus couldn\'t give this spoke the address {$a}: another spoke on this hub already has it.';
...
$string['statusbar_hub_site_changed'] = 'Courses with unpublished changes: {$a}';
$string['statusbar_hub_site_shared'] = 'Shared courses: {$a}';
$string['statusbar_hub_site_title'] = 'This hub';
